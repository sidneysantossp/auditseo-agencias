...
const methodologyCards = [
  ...
  { num: "04", title: "Observabilidade em IA (GEO)", desc: "Ajustes semânticos para auxiliar a compreensão da marca por sistemas generativos.", icon: <Bot size={22} className="text-[#b28453]" /> },
        ...
        <div className="container mx-auto px-6 xl:px-12 max-w-[1320px] relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            <div className="lg:col-span-6 text-left">
              ...
              <h2 className="font-display text-[32px] sm:text-[40px] md:text-[46px] font-bold text-[#f8f8f8] leading-[1.15] tracking-tight mb-6">Acompanhamento técnico e estratégico de sinais</h2>
