...
| **GEO** | `COMMERCIAL / METHODOLOGICAL` | Expressão de mercado usada para discutir otimização em ambientes de busca generativa; neste corpus, deve ser qualificada como linguagem editorial, não fator padronizado. | Pode afirmar que AUDITSEO usa o termo e estuda suas relações com SEO e AI Search. Não pode afirmar padrão universal, score, causalidade ou “GEO readiness” objetivamente demonstrada. | Pode nomear uma frente de diagnóstico se o contrato descrever observáveis e limitações; não pode prometer aparição em IA. |
