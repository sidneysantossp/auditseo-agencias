...
| :-- | :-- | :-- | :-- | :-- | :-- |
| **Pillar** (`/guias/ai-search`) | O que é AI Search e qual é a tese estrutural? | Fundacional / Estratégico | Ecossistema de busca generativa, transição de strings para subgrafos, modelo editorial AUDITSEO | Detalhes microscópicos de retrieval ou fórmulas de métricas | Visão macro e unificada da nova era da busca |
